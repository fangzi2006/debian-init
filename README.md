...
``` bash
curl -fsSL https://github.com/fangzi2006/debain-init/raw/refs/heads/main/init.sh | bash
```

中国使用gh代理

```bash
curl -fsSL https://gh.llkk.cc/https://github.com/fangzi2006/debain-init/raw/refs/heads/main/init.sh | bash
```
